...
@section('content')
    <div class="pull-right">
        {{ link_to_route('transactions.pdf', trans('transaction.invoice_pdf'), [$transaction->invoice_no], ['class' => 'btn btn-default', 'target' => '_blank']) }}
        {{ link_to_route('transactions.receipt', trans('transaction.invoice_print'), [$transaction->invoice_no], ['class' => 'btn btn-default', 'target' => '_blank']) }}
    </div>
